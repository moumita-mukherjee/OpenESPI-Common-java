...
public class Routes {
    ...
    public static final String AUTHORIZED_THIRD_PARTIES_MEMBER = "/RetailCustomer/{retailCustomerId}/AuthorizedThirdParties/{authorizationId}";
...
//    public static final String DATA_CUSTODIAN_REMOVE_ALL_OAUTH_TOKENS = "/custodian/oauth/users/{user}/tokens/{token}";
    ...
    public static final String THIRD_PARTY_LIST_CUSTODIAN = "/custodian/{retailCustomerId}/ThirdPartyList";
    public static final String THIRD_PARTY_AUTHORIZE = "/custodian/{thirdPartyId}/authorize";
    public static final String THIRD_PARTY_UNAUTHORIZE = "/custodian/{thirdPartyId}/unauthorize";
    public static final String THIRD_PARTY_SHOW = "/custodian/{thirdPartyId}/show";
    ...
    //
    public static final String ROOT_AUTHORIZATION_STATUS = "/espi/1_1/authorize/ReadAuthorizationStatus";
