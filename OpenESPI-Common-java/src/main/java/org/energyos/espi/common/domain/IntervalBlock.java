...
@NamedQueries(value = {
        ...
        @NamedQuery(name = IntervalBlock.QUERY_FIND_ALL_IDS_BY_USAGE_POINT_ID_PERIOD,
                query = "SELECT block.id FROM IntervalBlock block where block.meterReading.usagePoint.id = :usagePointId AND block.published >=:publishedMin AND block.published <=:publishedMax AND block.updated >=:updatedMin and block.updated <=:updatedMax AND block.interval.start >=:usageMin and block.interval.start <=:usageMax"),                
        ...
        @NamedQuery(name = IntervalBlock.QUERY_FIND_BY_PERIOD,
        query = "SELECT block FROM IntervalBlock block where block.meterReading.id = :meterReadingId and block.interval.start >= :fromTime and  block.interval.start <= :toTime"),                
        ...
        extends IdentifiedObject
{
    ...
    @XmlTransient
    //DJ @ManyToOne
    //DJ @JoinColumn(name = "meter_reading_id")
    //@Transient
    @ManyToOne
    ...
    @XmlTransient
    //@Column(name="meter_reading_id",updatable=true)
    @Transient
