...
@NamedQueries(value = {
        ...
        @NamedQuery(name = Authorization.QUERY_FIND_BY_REFRESH_TOKEN,query = "SELECT authorization FROM Authorization authorization WHERE authorization.refreshToken = :refershToken"),
...
public class Authorization
    ...
    //DJ @XmlElement(name = "referenceID")
    @XmlTransient
