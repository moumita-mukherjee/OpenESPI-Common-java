...
//    }
    ...
    public void getScope() {
        ApplicationInformation applicationInformation = EspiFactory.newApplicationInformation();
        assertThat(applicationInformation.getScope(), hasItem(new ApplicationInformationScope("FB=4_5_15;IntervalDuration=3600;BlockDuration=monthly;HistoryLength=13")));
        assertThat(applicationInformation.getScope(), hasItem(new ApplicationInformationScope("FB=4_5_16;IntervalDuration=3600;BlockDuration=monthly;HistoryLength=13")));
    }
