...
//    }
	...
	@Override
	public void updateAuthroizeStatus(Long thirdPartyId, boolean status) {
		ApplicationInformation applicationInformation = this.findById(thirdPartyId);
		applicationInformation.setAuthorized(status);
		this.persist(applicationInformation);
	}
