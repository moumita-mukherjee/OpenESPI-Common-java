...
public class ResourceServiceImpl implements ResourceService {
	 ...
	 * collection of the a parent resource. The resources are returned within a
	 * transactional context allowing for persistent mutation.
	 * 
	 * @param Long
	...
	public <T extends IdentifiedObject> List<Long> findAllIdsByUsagePointId(Long id, AtomPeriod ap, Class<T> clazz) {
		return repository.findAllIdsByUsagePointId(id, ap, clazz);
	}
	...
	@Transactional
	@Override
	public <T extends IdentifiedObject> void deleteByXPathId(Long id1, Long id2, Long id3, Long id4, Class<T> clazz) {
