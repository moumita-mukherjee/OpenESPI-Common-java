...
@NamedQueries(value = {
        ...
        @NamedQuery(name = ElectricPowerQualitySummary.QUERY_FIND_ALL_IDS_BY_USAGE_POINT_ID,
                query = "SELECT summary FROM ElectricPowerQualitySummary summary WHERE summary.usagePoint.id = :usagePointId"),
        @NamedQuery(name = ElectricPowerQualitySummary.QUERY_FIND_ALL_IDS,
        query = "SELECT electricPowerQualitySummary FROM ElectricPowerQualitySummary electricPowerQualitySummary"),
        @NamedQuery(name = ElectricPowerQualitySummary.QUERY_FIND_ALL_IDS_BY_XPATH_2, query = "SELECT e FROM UsagePoint u, ElectricPowerQualitySummary e WHERE u.retailCustomer.id = :o1Id AND  e.usagePoint.id = :o2Id"),
        @NamedQuery(name = ElectricPowerQualitySummary.QUERY_FIND_ID_BY_XPATH, query = "SELECT e FROM UsagePoint u, ElectricPowerQualitySummary e WHERE u.retailCustomer.id = :o1Id AND e.usagePoint.id = :o2Id AND e.id = :o3Id")
