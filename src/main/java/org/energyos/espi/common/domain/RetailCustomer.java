...
@NamedQueries(value = {
		@NamedQuery(name = RetailCustomer.QUERY_FIND_BY_UUID, query = "SELECT customer FROM RetailCustomer customer WHERE customer.uuid = :uuid"),
...
public class RetailCustomer extends IdentifiedObject implements UserDetails, Principal{
	...
	public final static String QUERY_FIND_BY_UUID = "RetailCustomer.findByUUID";
    public final static String QUERY_FIND_BY_ID = "RetailCustomer.findById";
    public final static String QUERY_FIND_BY_LINK = "RetailCustomer.findByLink";
