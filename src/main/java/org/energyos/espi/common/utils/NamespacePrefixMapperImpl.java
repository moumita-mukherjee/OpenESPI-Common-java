...
public class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
    ...
    private static final String CUSTOMER_NAMESPACE = "http://naesb.org/espi/cust";
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix){
    	...
    	if (StringUtils.isBlank(namespaceUri)) {
            return EMPTY_NAMESPACE_PREFIX;
        }
        if (ESPI_NAMESPACE.equalsIgnoreCase(namespaceUri)){
            return ESPI_NAMESPACE_PREFIX;
        }   
        if (ATOM_NAMESPACE.equalsIgnoreCase(namespaceUri)){
            return ATOM_NAMESPACE_PREFIX;
        }  
        
        if (CUSTOMER_NAMESPACE.equalsIgnoreCase(namespaceUri)){
            return CUSTOMER_NAMESPACE_PREFIX;
        } 
